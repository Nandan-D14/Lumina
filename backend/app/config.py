...
class Settings:
    ...
    kilo_code_api: str = os.getenv("KILO_API_KEY", os.getenv("KILO_CODE_API", "")).strip("'\"")
    kilo_code_model: str = os.getenv("KILO_MODEL", os.getenv("KILO_CODE_MODEL", "")).strip("'\"")
    kilo_code_endpoint: str = os.getenv("KILO_URL", os.getenv("KILO_CODE_ENDPOINT", "https://api.kilo.ai/api/gateway")).strip("'\"")
